...
public class Driver {
	...
	public static void main(String[] args) {
		...
		List<Account> acStatus3 = acService.getAllByStatus(3);

		System.out.println("Status id 3");
		for (Account as3 : acStatus3)
			System.out.println(as3);
		System.out.println(" ");

		List<Account> acStatus4 = acService.getAllByStatus(4);

		System.out.println("Status id 4");
		for (Account as4 : acStatus4)
		...
		List<Account> acUserid1 = acService.getAllByUser(1);

		System.out.println("User id = 1");
		for (Account acui1 : acUserid1)
			System.out.println(acui1);
		System.out.println(" ");

		List<Account> acUserid2 = acService.getAllByUser(2);
		...
		//System.out.println("Add Account default customer.");
		//System.out.println(" ");
		
		//String sql = "INSERT INTO account (balance, account_status_id, account_type, user_id)"
			//	+ "	VALUES (?, ?, ?, ?);";
		
		//Account newacc = new Account (100.00, 2, 2, );
